  ...
  <div class="py-5 overflow-y-auto">
      ...
      <ul class="space-y-1 font-medium">
         ...
         @elseif($role === 'secretaire')
            ...
            <li>
               <a href="{{ route('secretaire.forms.index') }}" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group {{ request()->routeIs('secretaire.forms.*') && ! request()->boolean('transferred') ? 'bg-neutral-tertiary text-fg-brand' : '' }}">
                  <svg class="shrink-0 w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                  <span class="ms-3 font-medium">Formulaires</span>
               </a>
            </li>
            <li>
               <a href="{{ route('secretaire.forms.index', ['transferred' => 1]) }}" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group {{ request()->routeIs('secretaire.forms.*') && request()->boolean('transferred') ? 'bg-neutral-tertiary text-fg-brand' : '' }}">
                  <svg class="shrink-0 w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                  <span class="ms-3 font-medium">Dossiers transmis</span>
               </a>
            </li>
            <li>
