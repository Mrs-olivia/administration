...
class FormulaireController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('secretaire.index', compact('formulaires'));
    }
    ...
    if ($request->hasFile('fichier')) {
        ...
        return redirect()->route('secretaire')->with('success', 'Formulaire rempli avec succès.');
    }
    ...
    {
        return view('secretaire.show', compact('formulaire'));
    }
    ...
    {
        return view('secretaire.edit', compact('formulaire'));
    }
    ...
    public function update(UpdateformulaireRequest $request, Formulaire $formulaire)
    {
        ...
        return redirect()->route('formulaires.show', $formulaire)->with('success', 'Formulaire modifié avec succès.');
    }
    ...
    public function destroy(Formulaire $formulaire)
    {
        ...
        return redirect()->route('secretaire')->with('success', 'Formulaire supprimé avec succès.');
    }
}
